...
void AVLTreeSecundario::export_to_hash(HashMap<string, Vector<string>> *map)
...
void AVLTreeSecundario::export_to_hash(AVLTreeNode *&node, HashMap<string, Vector<string>> *map)
{
    if (node != nullptr){
